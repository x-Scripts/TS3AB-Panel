<?php
  ...
  * @Filename: ChannelPasswordHash.php
  ...
  * @Last Modified time: 21-05-2020 12:57
  *
  * @Copyright(C) 2020 x-Scripts
  */

  class ChannelPasswordHash extends CI_Controller {
    public function index() {
      ...
      $req = request($this->input->post(),['botID','value'],['Podaj id bota!','Podaj czy hasło jest zakodowane!']);
      if(!$req['success']) {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/connect.channel_password.hashed/{$req['value']}"),true);
