<?php
  ...
  * Information
  * @Author: xares
  * @Date:   21-05-2020 13:16
  * @Filename: ColoredChat.php
  ...
  * @Last Modified time: 21-05-2020 13:18
  *
  * @Copyright(C) 2020 x-Scripts
  */

  class ColoredChat extends CI_Controller {
    public function index() {
      ...
      $req = request($this->input->post(),['botID','value'],['Podaj id bota!','Podaj czy ma być kolorowy czat!']);
      if(!$req['success']) {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/commands.color/{$req['value']}"),true);
