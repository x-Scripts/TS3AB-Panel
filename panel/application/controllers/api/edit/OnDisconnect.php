<?php
  ...
  */
  ...
  class OnDisconnect extends CI_Controller {
    public function index() {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/events.ondisconnect/\"".rawurlencode($req['value'])."\""),true);
