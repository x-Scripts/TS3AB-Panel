<?php
  ...
  * @Last Modified time: 21-05-2020 10:26
  *
  * @Copyright(C) 2020 x-Scripts
  */

  class RunBot extends CI_Controller {
    public function index() {
      ...
      $req = request($this->input->post(),['botID','value'],['Podaj id bota!','Podaj czy bot ma się uruchamiać przy starcie aplikacji!']);
      if(!$req['success']) {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/run/{$req['value']}"),true);
