<?php
  ...
  * Information
  * @Author: xares
  * @Date:   21-05-2020 14:39
  * @Filename: PartyDelay.php
  ...
  * @Last Modified time: 21-05-2020 14:39
  *
  * @Copyright(C) 2020 x-Scripts
  */

  class PartyDelay extends CI_Controller {
    public function index() {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/events.party_delay/\"".rawurlencode($req['value'])."\""),true);
