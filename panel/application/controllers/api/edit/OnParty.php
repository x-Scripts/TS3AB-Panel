<?php
  ...
  * Information
  * @Author: xares
  * @Date:   21-05-2020 14:35
  * @Filename: OnParty.php
  ...
  */
  ...
  class OnParty extends CI_Controller {
    public function index() {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/events.onparty/\"".rawurlencode($req['value'])."\""),true);
