<?php
  ...
  * Information
  * @Author: xares
  * @Date:   21-05-2020 12:15
  * @Filename: BotLanguage.php
  ...
  */
  ...
  class BotLanguage extends CI_Controller {
    public function index() {
      ...
      $req = request($this->input->post(),['botID','value'],['Podaj id bota!','Podaj język bota!']);
      if(!$req['success']) {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/language/\"{$req['value']}\""),true);
