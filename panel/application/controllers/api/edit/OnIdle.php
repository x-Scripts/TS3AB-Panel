<?php
  ...
  * @Last Modified time: 21-05-2020 14:41
  *
  * @Copyright(C) 2020 x-Scripts
  */

  class OnIdle extends CI_Controller {
    public function index() {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/events.onidle/\"".rawurlencode($req['value'])."\""),true);
