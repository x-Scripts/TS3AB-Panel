<?php
  ...
  * Information
  * @Author: xares
  * @Date:   21-05-2020 11:44
  * @Filename: LoadAvatar.php
  ...
  */
  ...
  class LoadAvatar extends CI_Controller {
    public function index() {
      ...
      $req = request($this->input->post(),['botID','value'],['Podaj id bota!','Podaj czy ma być ładowana okładka utworu!']);
      if(!$req['success']) {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/generate_status_avatar/{$req['value']}"),true);
