<?php
  ...
  * @Filename: ChannelPasswordAutoHash.php
  ...
  */
  ...
  class ChannelPasswordAutoHash extends CI_Controller {
    public function index() {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/connect.channel_password.autohash/{$req['value']}"),true);
