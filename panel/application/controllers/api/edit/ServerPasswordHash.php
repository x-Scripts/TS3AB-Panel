<?php
  ...
  * @Filename: ServerPasswordHash.php
  ...
  */
  ...
  class ServerPasswordHash extends CI_Controller {
    public function index() {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/connect.server_password.hashed/{$req['value']}"),true);
