<?php
  ...
  * Information
  * @Author: xares
  * @Date:   21-05-2020 12:49
  * @Filename: ServerPassword.php
  ...
  * @Last Modified time: 21-05-2020 12:52
  *
  * @Copyright(C) 2020 x-Scripts
  */

  class ServerPassword extends CI_Controller {
    public function index() {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/connect.server_password.pw/\"{$req['value']}\""),true);
