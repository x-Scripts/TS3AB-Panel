<?php
  ...
  * Information
  * @Author: xares
  * @Date:   21-05-2020 14:37
  * @Filename: IdleTime.php
  ...
  */
  ...
  class IdleTime extends CI_Controller {
    public function index() {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/events.idletime/\"".rawurlencode($req['value'])."\""),true);
