<?php
  ...
  * Information
  * @Author: xares
  * @Date:   21-05-2020 14:28
  * @Filename: OnConnect.php
  ...
  * @Last Modified time: 21-05-2020 14:37
  *
  * @Copyright(C) 2020 x-Scripts
  */

  class OnConnect extends CI_Controller {
    public function index() {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/events.onconnect/\"".rawurlencode($req['value'])."\""),true);
