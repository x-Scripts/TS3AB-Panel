<?php
  ...
  * Information
  * @Author: xares
  * @Date:   21-05-2020 13:26
  * @Filename: LongMessage.php
  ...
  * @Last Modified time: 21-05-2020 13:28
  *
  * @Copyright(C) 2020 x-Scripts
  */

  class LongMessage extends CI_Controller {
    public function index() {
      ...
      $req = request($this->input->post(),['botID','value'],['Podaj id bota!','Podaj długość komend!']);
      if(!$req['success']) {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/commands.long_message/{$req['value']}"),true);
