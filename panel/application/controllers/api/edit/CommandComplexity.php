<?php
  ...
  * Information
  * @Author: xares
  * @Date:   21-05-2020 13:33
  * @Filename: CommandComplexity.php
  ...
  * @Last Modified time: 21-05-2020 13:34
  *
  * @Copyright(C) 2020 x-Scripts
  */

  class CommandComplexity extends CI_Controller {
    public function index() {
      ...
      $req = request($this->input->post(),['botID','value'],['Podaj id bota!','Podaj ile poleceń można wykonać na raz!']);
      if(!$req['success']) {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/commands.command_complexity/{$req['value']}"),true);
