<?php
  ...
  * Information
  * @Author: xares
  * @Date:   21-05-2020 14:40
  * @Filename: AloneDelay.php
  ...
  * @Last Modified time: 21-05-2020 14:40
  *
  * @Copyright(C) 2020 x-Scripts
  */

  class AloneDelay extends CI_Controller {
    public function index() {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/events.alone_delay/\"".rawurlencode($req['value'])."\""),true);
