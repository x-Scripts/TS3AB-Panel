<?php
  ...
  * Information
  * @Author: xares
  * @Date:   21-05-2020 13:03
  * @Filename: MaxVolume.php
  ...
  * @Last Modified time: 21-05-2020 13:16
  *
  * @Copyright(C) 2020 x-Scripts
  */

  class MaxVolume extends CI_Controller {
    public function index() {
      ...
      $req = request($this->input->post(),['botID','value'],['Podaj id bota!','Podaj maksymalną głośność!']);
      if(!$req['success']) {
      ...
      $run = json_decode($this->ts3ab->command("settings/bot/set/{$req['botID']}/audio.max_user_volume/{$req['value']}"),true);
